...
module OpenApiSDK
  ...
  class Disputes
    ...
    sig {
      params(
        request: Models::Operations::DisputesListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DisputesListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::DisputesListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResourceDispute)
          response = Models::Operations::DisputesListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_dispute: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::DisputesListRequest.new(
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::DisputesGetResponse)
    }
    def get(id:, timeout_ms: nil, http_headers: nil)
      ...
      #
      # **Scopes**: `disputes:read`
      request = Models::Operations::DisputesGetRequest.new(
        id: id
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::DisputesGetRequest,
        base_url,
        "/v1/disputes/{id}",
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response = Models::Operations::DisputesGetResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
