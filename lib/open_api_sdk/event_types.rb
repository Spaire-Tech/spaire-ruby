...
module OpenApiSDK
  ...
  class EventTypes
    ...
    sig {
      params(
        request: Models::Operations::EventTypesListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::EventTypesListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      url = "#{base_url}/v1/event-types/"
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      query_params = Utils.get_query_params(Models::Operations::EventTypesListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response = Models::Operations::EventTypesListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_event_type_with_stats: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::EventTypesListRequest.new(
                organization_id: request.organization_id,
                customer_id: request.customer_id,
                external_customer_id: request.external_customer_id,
                query: request.query,
                root_events: request.root_events,
    ...
    sig {
      params(
        body: Models::Components::EventTypeUpdate,
        id: ::String,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::EventTypesUpdateResponse)
    }
    def update(body:, id:, timeout_ms: nil, http_headers: nil)
      # update - Update Event Type
      # Update an event type's label.
      request = Models::Operations::EventTypesUpdateRequest.new(
        id: id,
        body: body
      )
      url, params = @sdk_configuration.get_server_details
      ...
      url = Utils.generate_url(
        Models::Operations::EventTypesUpdateRequest,
        base_url,
        "/v1/event-types/{id}",
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::EventType)
          response = Models::Operations::EventTypesUpdateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            event_type: T.unsafe(obj)
          )
