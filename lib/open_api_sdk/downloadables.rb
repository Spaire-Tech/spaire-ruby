...
module OpenApiSDK
  ...
  class Downloadables
    ...
    sig {
      params(
        security: Models::Operations::CustomerPortalDownloadablesListSecurity,
        ...
        .returns(Models::Operations::CustomerPortalDownloadablesListResponse)
    }
    def list(security:, benefit_id: nil, page: nil, limit: nil, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::CustomerPortalDownloadablesListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResourceDownloadableRead)
          response = Models::Operations::CustomerPortalDownloadablesListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_downloadable_read: T.unsafe(obj)
          )
          sdk = self
