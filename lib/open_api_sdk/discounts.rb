...
module OpenApiSDK
  ...
  class Discounts
    ...
    sig {
      params(
        request: Models::Operations::DiscountsListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DiscountsListResponse)
    }
    ...
    sig {
      params(
        request: T.any(
          Models::Components::DiscountFixedOnceForeverDurationCreate,
          Models::Components::DiscountFixedRepeatDurationCreate,
          Models::Components::DiscountPercentageOnceForeverDurationCreate,
          Models::Components::DiscountPercentageRepeatDurationCreate
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DiscountsCreateResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::DiscountsGetResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::DiscountsDeleteResponse)
    }
    ...
    sig {
      params(
        body: Models::Components::DiscountUpdate,
        id: ::String,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::DiscountsUpdateResponse)
    }
