...
module OpenApiSDK
  ...
  class CheckoutLinks
    ...
    sig {
      params(
        request: Models::Operations::CheckoutLinksListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::CheckoutLinksListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::CheckoutLinksListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResourceCheckoutLink)
          response = Models::Operations::CheckoutLinksListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_checkout_link: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::CheckoutLinksListRequest.new(
    ...
    sig {
      params(
        request: T.any(
          Models::Components::CheckoutLinkCreateProductPrice,
          Models::Components::CheckoutLinkCreateProduct,
          Models::Components::CheckoutLinkCreateProducts
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::CheckoutLinksCreateResponse)
    }
    def create(request:, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["201"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::CheckoutLink)
          response = Models::Operations::CheckoutLinksCreateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            checkout_link: T.unsafe(obj)
          )
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::CheckoutLinksGetResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::CheckoutLinksDeleteResponse)
    }
    ...
    sig {
      params(
        body: Models::Components::CheckoutLinkUpdate,
        id: ::String,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::CheckoutLinksUpdateResponse)
    }
