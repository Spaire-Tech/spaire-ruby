  ...
  class SpaireOrganizations
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::CustomerPortalOrganizationsGetResponse)
    }
    def get(slug:, timeout_ms: nil, http_headers: nil)
      # get - Get Organization
      # Get a customer portal's organization by slug.
      request = Models::Operations::CustomerPortalOrganizationsGetRequest.new(
        slug: slug
      )
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::CustomerOrganizationData)
          response = Models::Operations::CustomerPortalOrganizationsGetResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            customer_organization_data: T.unsafe(obj)
          )
