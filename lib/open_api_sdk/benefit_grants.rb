...
module OpenApiSDK
  ...
  class BenefitGrants
    ...
    sig {
      params(
        request: Models::Operations::BenefitGrantsListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::BenefitGrantsListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      url = "#{base_url}/v1/benefit-grants/"
      headers = {}
      headers = T.cast(headers, T::Hash[String, String])
      query_params = Utils.get_query_params(Models::Operations::BenefitGrantsListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response = Models::Operations::BenefitGrantsListResponse.new(
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::BenefitGrantsListRequest.new(
