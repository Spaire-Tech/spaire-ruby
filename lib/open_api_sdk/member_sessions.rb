...
module OpenApiSDK
  ...
  class MemberSessions
    ...
    sig {
      params(
        request: Models::Components::MemberSessionCreate,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::MemberSessionsCreateResponse)
    }
    def create(request:, timeout_ms: nil, http_headers: nil)
      ...
      url = "#{base_url}/v1/member-sessions/"
      headers = {}
      ...
      hook_ctx = SDKHooks::HookContext.new(
        ...
        base_url: base_url,
        oauth2_scopes: nil,
        operation_id: "member-sessions:create",
      ...
      if Utils.match_status_code(http_response.status, ["201"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::MemberSession)
          response = Models::Operations::MemberSessionsCreateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            member_session: T.unsafe(obj)
          )
