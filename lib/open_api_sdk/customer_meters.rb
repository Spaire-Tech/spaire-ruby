...
module OpenApiSDK
  ...
  class CustomerMeters
    ...
    sig {
      params(
        request: Models::Operations::CustomerMetersListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::CustomerMetersListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::CustomerMetersListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResourceCustomerMeter)
          response = Models::Operations::CustomerMetersListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_customer_meter: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::CustomerMetersListRequest.new(
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::CustomerMetersGetResponse)
    }
    def get(id:, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::CustomerMeter)
          response = Models::Operations::CustomerMetersGetResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            customer_meter: T.unsafe(obj)
          )
