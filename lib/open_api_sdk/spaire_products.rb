...
module OpenApiSDK
  ...
  class SpaireProducts
    ...
    sig {
      params(
        request: Models::Components::ProductTaxPreviewRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::ProductsProductsPreviewTaxResponse)
    }
    def preview_tax(request:, timeout_ms: nil, http_headers: nil)
      # preview_tax - Preview Tax
      ...
      url = "#{base_url}/v1/products/tax-preview"
      headers = {}
      ...
      hook_ctx = SDKHooks::HookContext.new(
        ...
        base_url: base_url,
        oauth2_scopes: nil,
        operation_id: "products:products:preview_tax",
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ProductTaxPreviewResponse)
          response = Models::Operations::ProductsProductsPreviewTaxResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            product_tax_preview_response: T.unsafe(obj)
          )
