...
module OpenApiSDK
  ...
  class Refunds
    ...
    sig {
      params(
        request: Models::Operations::RefundsListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::RefundsListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::RefundsListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResourceRefund)
          response = Models::Operations::RefundsListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource_refund: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::RefundsListRequest.new(
                id: request.id,
    ...
    sig {
      params(
        request: Models::Components::RefundCreate,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::RefundsCreateResponse)
    }
    def create(request:, timeout_ms: nil, http_headers: nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::Refund)
        ...
        if Utils.match_content_type(content_type, "application/json")
          ...
          response_data = http_response.env.response_body
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Errors::RefundedAlready)
          raise obj
        else
          raise(
            ::OpenApiSDK::Models::Errors::APIError.new(
