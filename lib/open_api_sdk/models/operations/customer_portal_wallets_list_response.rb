  ...
  module Models
    module Operations
      ...
      class CustomerPortalWalletsListResponse
        ...
        sig { returns(T.proc.returns(T.nilable(CustomerPortalWalletsListResponse))) }
        ...
        # Successful Response
        field :list_resource_customer_wallet, Crystalline::Nilable.new(Models::Components::ListResourceCustomerWallet)
        ...
        sig {
          params(
            ...
            list_resource_customer_wallet: T.nilable(Models::Components::ListResourceCustomerWallet)
          )
            .void
        }
