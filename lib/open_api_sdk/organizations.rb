  ...
  class Organizations
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::OrganizationsListResponse)
    }
    ...
    sig {
      params(
        request: Models::Components::OrganizationCreate,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::OrganizationsCreateResponse)
    }
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::OrganizationsGetResponse)
    }
    ...
    sig {
      params(
        body: Models::Components::OrganizationUpdate,
        id: ::String,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::OrganizationsUpdateResponse)
    }
