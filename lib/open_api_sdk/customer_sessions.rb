...
module OpenApiSDK
  ...
  class CustomerSessions
    ...
    sig {
      params(
        request: T.any(
          Models::Components::CustomerSessionCustomerIDCreate,
          Models::Components::CustomerSessionCustomerExternalIDCreate
        ),
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::CustomerSessionsCreateResponse)
    }
    def create(request:, timeout_ms: nil, http_headers: nil)
      ...
      url = "#{base_url}/v1/customer-sessions/"
      headers = {}
      ...
      if Utils.match_status_code(http_response.status, ["201"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::CustomerSession)
          response = Models::Operations::CustomerSessionsCreateResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            customer_session: T.unsafe(obj)
          )
