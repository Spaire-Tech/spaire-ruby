...
module OpenApiSDK
  ...
  class Payments
    ...
    sig {
      params(
        request: Models::Operations::PaymentsListRequest,
        timeout_ms: T.nilable(Integer),
        http_headers: T.nilable(T::Hash[T.any(String, Symbol), String])
      )
        .returns(Models::Operations::PaymentsListResponse)
    }
    def list(request:, timeout_ms: nil, http_headers: nil)
      ...
      query_params = Utils.get_query_params(Models::Operations::PaymentsListRequest, request, nil)
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          obj = Crystalline.unmarshal_json(JSON.parse(response_data), Models::Components::ListResource)
          response = Models::Operations::PaymentsListResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            list_resource: T.unsafe(obj)
          )
          sdk = self
          ...
          response.next_page = proc do
            ...
            sdk.list(
              request: Models::Operations::PaymentsListRequest.new(
    ...
    sig {
      params(
        ...
        .returns(Models::Operations::PaymentsGetResponse)
    }
    def get(id:, timeout_ms: nil, http_headers: nil)
      ...
      #
      # **Scopes**: `payments:read`
      request = Models::Operations::PaymentsGetRequest.new(
        id: id
      )
      url, params = @sdk_configuration.get_server_details
      base_url = Utils.template_url(url, params)
      url = Utils.generate_url(
        Models::Operations::PaymentsGetRequest,
        base_url,
        "/v1/payments/{id}",
        request
      )
      ...
      if Utils.match_status_code(http_response.status, ["200"])
        if Utils.match_content_type(content_type, "application/json")
          ...
          response = Models::Operations::PaymentsGetResponse.new(
            status_code: http_response.status,
            content_type: content_type,
            raw_response: http_response,
            payment: T.unsafe(obj)
          )
