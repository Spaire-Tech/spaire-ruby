...
Gem::Specification.new do |s|
  ...
  s.summary     = ''
  s.homepage    = 'https://github.com/Spaire-Tech/spaire-ruby.git'
  s.description = 'Ruby SDK for the Spaire API'
  s.authors     = ['Spaire']
  s.metadata    = {
    'homepage_uri' => 'https://github.com/Spaire-Tech/spaire-ruby.git',
    'documentation_uri' => 'https://github.com/Spaire-Tech/spaire-ruby.git',
    'source_code_uri' => 'https://github.com/Spaire-Tech/spaire-ruby.git'
  }
