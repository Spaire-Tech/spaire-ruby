...
* [vote_poll_customer](#vote_poll_customer) - Vote on Community Post Poll
...
<!-- UsageSnippet language="ruby" operationID="customer_portal_community:vote_poll_customer" method="post" path="/v1/customer-portal/community/{course_id}/posts/{post_id}/poll/vote" -->
```ruby
require 'spaire'

Models = ::OpenApiSDK::Models
s = ::OpenApiSDK::Spaire.new
res = s.customer_portal_community.vote_poll_customer(security: Models::Operations::CustomerPortalCommunityVotePollCustomerSecurity.new(
  customer_session: '<YOUR_BEARER_TOKEN_HERE>'
), course_id: '<value>', post_id: '<value>', body: Models::Components::CommunityPollVote.new(
  option_id: '<id>'
))

unless res.community_poll_read.nil?
  # handle response
end
...
| Parameter                                                                                                                                         | Type                                                                                                                                              | Required                                                                                                                                          | Description                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `security`                                                                                                                                        | [Models::Operations::CustomerPortalCommunityVotePollCustomerSecurity](../../models/operations/customerportalcommunityvotepollcustomersecurity.md) | :heavy_check_mark:                                                                                                                                | The security requirements to use for the request.                                                                                                 |
| `course_id`                                                                                                                                       | *::String*                                                                                                                                        | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               |
| `post_id`                                                                                                                                         | *::String*                                                                                                                                        | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               |
| `body`                                                                                                                                            | [Models::Components::CommunityPollVote](../../models/shared/communitypollvote.md)                                                                 | :heavy_check_mark:                                                                                                                                | N/A                                                                                                                                               |

### Response

**[T.nilable(Models::Operations::CustomerPortalCommunityVotePollCustomerResponse)](../../models/operations/customerportalcommunityvotepollcustomerresponse.md)**
